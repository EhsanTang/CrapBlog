package com.biyao.common.framework.controller;
...
import com.biyao.common.bean.result.ByJsonResult;
...
import com.biyao.common.exception.ByException;
...
public abstract class BaseController {
     ...
     * @see com.biyao.common.bean.result.ByJsonResult 返回报文结构ByJsonResult
     * @see com.biyao.common.exception.ByException 	  业务异常ByException
     * @param request 请求
     * @param response 响应
     * @param ex 异常
     * @return ByJsonResult
